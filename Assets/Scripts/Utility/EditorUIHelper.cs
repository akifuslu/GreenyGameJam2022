...
namespace Utility
{
    public static class EditorUIHelpers
    {
        ...
        // Hotkey: Alt+A
        [MenuItem("Tools/Utils/UIHelper/Anchor To Rect &a")]
        public static void MoveAnchorsToCorners()
        {
            EditorUtils.GetSelectedComponents<RectTransform>().ForEach(it =>
            {
                ...
                it.MoveAnchorsToCorners();
            });
        }

        [MenuItem("Tools/Utils/UIHelper/Anchor To Rect Width")]
        public static void MoveAnchorsToCorners_Width()
        {
            EditorUtils.GetSelectedComponents<RectTransform>().ForEach(it =>
            {
                Undo.RecordObject(it, "MoveAnchorsToCorners_Width");
                it.MoveAnchorsToCorners_Width();
            });
        }

        [MenuItem("Tools/Utils/UIHelper/Anchor To Rect Height")]
